...
public class BoundProcessor {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println(addZero(sss)); System.out.println("....." +
		 * isDouble("3.1s.23")); System.out.println(isVariable("3a"));
		 ...
		 * 
		 * String instantStr = "20:33:24:34"; String resultStr =
		 * instantStr.replaceAll("(\\d{2}):\\d{2}$", ":034$1");
